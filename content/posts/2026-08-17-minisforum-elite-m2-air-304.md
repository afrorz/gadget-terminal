...
buy:
- name: Minisforum Elite Mini M2 Air-304
  merchant: minisforum
  url: https://store.minisforum.com/products/minisforum-m2-air-mini-pc
  price: ベアボーンズ263ドル、16GB RAM/500GB SSD構成559ドル（いずれも掲載時点のセール価格）
  ships_jp: true
  giteki: 未取得
...
- q: 日本で買えますか
  a: Minisforum公式ストアから海外発送で購入自体は可能です。ただし技適は掲載時点で未取得で、国内保証やサポート窓口も付きません。
- q: 日本の100Vで使えますか
...
**技適** — Minisforum公式ストアの仕様表ではWi-Fi 6E・Bluetooth 5.4の搭載が明記されているが、技適マークや日本向け認証への言及はない。掲載時点で未取得として扱う。デュアル2.5GbEの有線運用に絞れば無線を使わずに済むが、Wi-Fi/Bluetoothを使う場合は技適取得の確認が必要になる。

**購入経路** — Minisforum公式ストアから購入でき、日本への発送自体は可能。ただし海外からの個人輸入の扱いで、国際送料・関税が別途かかり、国内保証やサポート窓口は付かない。
