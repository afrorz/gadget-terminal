...
description: 白いガジェットは検索すればいくらでも出てきますが、日本で正規に、サポート付きで買えるものは限られます。技適・PSEの状況を製品ごとに確認してまとめました。
lede: 白は「安っぽく見えない色」として海外ガジェットで増えています。見た目だけでなく、国内正規流通と技適・PSEの状況まで確認したものだけを並べました。
updated: 2026-09-05
products:
  - name: OB-4 White
    brand: teenage engineering
    image: "https://musiclandkey.fs-storage.jp/fs2cabinet/te-/te-ob-4-white/te-ob-4-white-m-01-dl.jpg"
    credit: MUSIC LAND KEY 製品ページ
    price: 121,000円(税別、掲載時点)
    where: Media Integration(MIオンラインストア)が日本正規輸入代理店。イケベ楽器・サウンドハウス・島村楽器・ミュージックランドKEYなど国内の楽器店でも扱いがある
    giteki: 取得済みとみなせる。Bluetooth機器の正規輸入代理店経由での国内販売は、技適を通っていることが前提になる
    note: |
    ...
    url: https://www.musicland.co.jp/fs/musiclandkey/te-ob-4-white
    source: https://store.minet.jp/category/_TEENAGE_ENG/
    availability: verified
  - name: Ear (a) White
    brand: Nothing
    image: "https://cdn.shopify.com/s/files/1/0582/6242/1665/files/0000s_0026_Ear-a-white.png?v=1753694936"
    credit: Nothing Japan公式サイト(jp.nothing.tech)
    price: 通常12,800円、セール時9,800円(掲載時点)
    where: Nothing Japan公式サイト(jp.nothing.tech)から直接購入できる
    giteki: 前モデルNothing ear(1)ではパッケージ側面に技適マークの掲載が確認されている。日本仕様として展開されており、Ear (a)も同様とみなせる
    note: |
  ...
  - name: K3 Max White
    brand: Keychron
    image: "https://superkopek.jp/cdn/shop/files/k3max-O1-JIS_1024x1024.jpg?v=1732674021"
    credit: SUPER KOPEK(KOPEK JAPAN)製品ページ
    price: 19,360円(掲載時点)
    where: KOPEK JAPAN(SUPER KOPEK)が日本正規輸入代理店。公式サイトから直接購入できる
    giteki: 取得済み。KOPEK JAPANが「国内正規代理店のKeychron製品は技適を取得した製品となる」と公式に明記している
    note: |
...
excluded:
  ...
  - name: ANBERNIC の白色モデル
    why: レトロデザイン特集の調査時点で、日本語公式ストア(jp.anbernic.com)に運営会社名・特定商取引法に基づく表示・技適に関する記載のいずれも確認できませんでした。同じ理由で今回も見送っています。
related:
  - keychron-v6-ultra-hybrid-tmr
  - xiaomi-magnetic-bluetooth-speaker
  - cmf-buds-neo
  - kbd0-curve0-v2
---

「白いガジェット」で検索すると、それらしい製品はいくらでも出てきます。ただ、そのうち**日本で正規に、サポート付きで買えるもの**となると急に数が減ります。

理由は2つです。ひとつは技適で、無線を積む製品は正規流通に乗っているかどうかで判断が変わります。もうひとつはPSEで、コンセントに挿す製品は無線の有無に関わらず電気用品安全法の対象になります。白い筐体は特に中国の小規模メーカー発が多く、どちらも確認せずに「買える」とは言えません。

そこでこのページでは、次の条件を満たしたものだけを並べています。

- **メーカー公式または日本の正規代理店が国内販売している**こと
- **技適(無線機器の場合)またはPSE(電源を使う機器の場合)の状況を確認できた**こと
